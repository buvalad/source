...
// --- Functie instantiere materiale: ---

CGrannyMaterial* CGrannyModelInstance::GetMaterialPtr(DWORD index)
{
	if (index >= m_kMtrlPal.GetMaterialCount())
		return nullptr;
	return &m_kMtrlPal.GetMaterialRef(index);
}
